...
export function DraftCompare({ open, onClose }: DraftCompareProps) {
  ...
  // Effect drives an async git compare whose result updates multiple pieces
  // of local state — the right boundary for setting state in reaction to
  // (open, draftA, draftB) changes.
  useEffect(() => {
