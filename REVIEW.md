...
- **Known gaps**: Linux Qt frontend remains out of scope for this branch. The cross-frontend harness still logs existing hierarchy repair after Swift/C# writer passes; that is tracked separately as R-18, not introduced here.
